        ...
        <div className="card-img-text">
          ...
          <div className="card-text">
            ...
            <p>
              ...
              HackShow 2/2020 in Web development category. The project was
              created in cooperation with my colleague.
            </p>
      ...
      <div className="card">
        <div className="card-img-text">
          ...
          <div className="card-text">
            ...
            <p>
              The second Iron Hack project. The project was created in
      ...
      <div className="card">
        <div className="card-img-text">
          ...
          <div className="card-text">
            <h4>TapApp</h4>
            <p>
              Application uses BreweryDB's API to search breweries by country
              and beers by name, type and country.
            </p>
      ...
      <div className="card">
        <div className="card-img-text">
          ...
          <div className="card-text">
            <h4>Iron Beers</h4>
            <p>
              Application uses API to show the list of beers, random beer,
              beer's details and allow to create a new beer.
            </p>
        ...
        <div className="card-img-text">
          ...
          <div className="card-text">
            ...
            <p>
              ...
              detail page of recipe, delete, update recipes and create own
              recipe.
            </p>
